...
class Blockchain {
    ...
    _addBlock(block) {
        ...
        return new Promise(async (resolve, reject) => {
            try {
                // setup the height of the block, genesis block will have height 0
                ...
                // setup the hash of the block
                block.hash = SHA256(block.height + block.previousBlockHash + block.timestamp + JSON.stringify(block.data)).toString();
